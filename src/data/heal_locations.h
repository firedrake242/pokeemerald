static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TEST_ISLAND_LOW_TIDE - 1] = {MAP_GROUP(TEST_ISLAND_LOW_TIDE), MAP_NUM(TEST_ISLAND_LOW_TIDE), 0, 0},
    [HEAL_LOCATION_NEW_MAP1 - 1] = {MAP_GROUP(NEW_MAP1), MAP_NUM(NEW_MAP1), 0, 0},
    [HEAL_LOCATION_RUSTBORO_2 - 1] = {MAP_GROUP(RUSTBORO_2), MAP_NUM(RUSTBORO_2), 0, 0},
};
